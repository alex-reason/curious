    ...
    useGSAP(() => {
        const clipAnimation = gsap.timeline({
            scrollTrigger: {
                trigger: '#clip',
                start: 'center center',
                end: '+=800 center', //will end 800 pixels after start (center)
                scrub: 0.5,
                pin: true,
                pinSpacing: true,
            }
        ...
        <div id="about" className="min-h-screen w-screen ">
            <div className="relative mb-8 mt-36  flex flex-col items-center gap-5">
                ...
                <div className="about-subtext">
                    ...
                    <p>Uniting every players from countless games and platforms</p>
                </div>
            </div>
            ...
            <div className="h-dvh w-screen" id="clip">
                <div className="mask-clip-path about-image">
                    <Image
                        ...
                        src="/images/about.webp" alt="background image" />
                </div>
            </div>
        </div>
    )
